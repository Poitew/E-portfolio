        ...
        <div className={styles.section} id="about-me-ID" >
            <div className={styles.historyContainer}>
                ...
                <p className={styles.history}>
                    Hi! I'm sickpoitew, a 18-year-old student and IT enthusiast based in Italy with 4 years of 
                    ...
                    I also have a deep interest in a lower level programming, particularly with C++ and Rust.
