...
function AboutMe() {
	...
	return (
		<motion.div
			...
			viewport={{ once: true }}
			className="flex flex-col xl:flex-row items-baseline gap-x-24 mb-56 mt-16 xl:mt-0"
			id="about-me-ID"
		>
			<div className="flex w-full flex-col items-center xl:items-start">
				...
				<p className="md:w-8/12 xl:w-xl text-center xl:text-left mt-5 text-sm/7 xl:pl-14 text-slate-400">
					...
					<br />
					<br />
					Since I started programming I've always been interested in full stack
					development and a sort of lower level programming (specifically with C++ and
					Rust). <br />
					Along the way I found interest in the DevOps environment, and closely related,
					in networking.
					<br />
					<br />
					In my free time I love studying anything tech-related, reading books and
					listening to music. I also have a blog where I share tutorials, and informations
					for fun.
				</p>
			</div>
